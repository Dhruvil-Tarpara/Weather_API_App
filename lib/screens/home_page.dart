...
import 'package:weatherapp/globals/global.dart';
import 'package:weatherapp/helpers/api_helpers.dart';
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    "Today,${Global.months[currentDate.month - 1]} ${currentDate.day} ${currentDate.hour}:${currentDate.minute}",style: myStyle3,),
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Row(
                                    mainAxisAlignment:
